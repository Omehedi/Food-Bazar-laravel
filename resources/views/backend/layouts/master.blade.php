...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="{{ asset('backend/index.html') }}">Concept</a>
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        ...
                                        <div id="submenu-1-2" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/index.html') }}">E Commerce Dashboard</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/ecommerce-product.html') }}">Product List</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/ecommerce-product-single.html') }}">Product Single</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/ecommerce-product-checkout.html') }}">Product Checkout</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/dashboard-finance.html') }}">Finance</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/dashboard-sales.html') }}">Sales</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div id="submenu-1-1" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/dashboard-influencer.html') }}">Influencer</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/influencer-finder.html') }}">Influencer Finder</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ asset('backend/influencer-profile.html') }}">Influencer Profile</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
...
{{--                                    </li>--}}
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-3" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/chart-c3.html') }}">C3 Charts</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/chart-chartist.html') }}">Chartist Charts</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/chart-charts.html') }}">Chart</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/chart-morris.html') }}">Morris</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/chart-sparkline.html') }}">Sparkline</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/chart-gauge.html') }}">Guage</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item ">
                            ...
                            <div id="submenu-4" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/form-elements.html') }}">Form Elements</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/form-validation.html') }}">Parsely Validations</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/multiselect.html') }}">Multiselect</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/datepicker.html') }}">Date Picker</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/bootstrap-select.html') }}">Bootstrap Select</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div id="submenu-5" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/general-table.html') }}">General Tables</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/data-tables.html') }}">Data Tables</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-6" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/blank-page.html') }}">Blank Page</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/sign-up.html') }}">Sign up Page</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/forgot-password.html') }}">Forgot Password</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/pricing.html') }}">Pricing Tables</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/timeline.html') }}">Timeline</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/calendar.html') }}">Calendar</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/sortable-nestable-lists.html') }}">Sortable/Nestable List</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/widgets.html') }}">Widgets</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/media-object.html') }}">Media Objects</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/cropper-image.html') }}">Cropper</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/color-picker.html') }}">Color Picker</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div id="submenu-7" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/inbox.html') }}">Inbox</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/email-details.html') }}">Email Detail</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/email-compose.html') }}">Email Compose</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/message-chat.html') }}">Message Chat</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div id="submenu-8" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/icon-fontawesome.html') }}">FontAwesome Icons</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/icon-material.html') }}">Material Icons</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/icon-simple-lineicon.html') }}">Simpleline Icon</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/icon-themify.html') }}">Themify Icon</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/icon-flag.html') }}">Flag Icons</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/icon-weather.html') }}">Weather Icon</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div id="submenu-9" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/map-google.html') }}">Google Maps</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('backend/pages/map-vector.html') }}">Vector Maps</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        Copyright © 2018 Concept. All rights reserved. Dashboard by <a href="https://colorlib.com/wp/" rel="{{asset('backend/')}}">Colorlib</a>.
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{asset('backend/')}}">About</a>
                            <a href="{{asset('backend/')}}">Support</a>
                            <a href="{{asset('backend/')}}">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
